...
### Java Backend / Full Stack Developer | Spring Boot | REST APIs
...
**Backend:** Java, Spring Boot, Spring MVC, REST APIs, JDBC, Hibernate  
**Databases:** MySQL, Oracle  
**DevOps & Cloud:** Docker, AWS EC2, Maven  
**Web Basics:** HTML, CSS, JavaScript  
**Tools:** Git, GitHub, Eclipse, VS Code, Postman, Apache Tomcat  
